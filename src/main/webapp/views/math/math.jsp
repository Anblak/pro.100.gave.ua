...
<body>
	<div class="mainMathDiv">

		<div class="heder" style="background-image:url(${heder});"></div>
		<div class="left" style="background-image:url(${LeftBodyDiv});">
			...
			<div class="field">
				...
				<form:form modelAttribute="baseActionWrapper" action="do"
					...
					<div class="input"
						style="background-image: url(img/input.png); width: 315px; height: 50px;">

						<p id="pInputFormul" class="formulP">
							<input name="formul" placeholder="formul" class="formul"
								id="formul" onfocus="inputFormul()">
						</p>
						<p id="pInputSpace" class="spaceP">
		...
		<div class="right"
			style="background-image: url(img/copybookRight.png); width: 469px; height: 750px; position: absolute; left: 900px; top: 210px">
			<div class="answer">${space}${resalt}${answer}</div>
		</div>
		<div class="fotter"
			style="background-image: url(img/footer.png); width: 1360px; height: 63px; left0px; top: 963px;"></div>
